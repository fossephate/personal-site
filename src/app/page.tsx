          ...
          <div className="w-full sm:w-1/2 space-y-4">
            ...
            <div>
              <div className="flex gap-6" style={{ cursor: "pointer" }}>
                ...
                <a className="group -m-1 p-1" aria-label="Follow on Bluesky" href="https://bsky.app/profile/fossephate.bsky.social">
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="w-[20px] h-[28px] fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                    <path d="M5.43 1.762c2.66 1.997 5.52 6.046 6.57 8.218 1.05-2.172 3.91-6.22 6.57-8.218 1.92-1.441 5.03-2.556 5.03.992 0 .708-.406 5.952-0.644 6.803-.828 2.959-3.846 3.714-6.53 3.257 4.692.799 5.886 3.444 3.308 6.089-4.896 5.024-7.036-1.26-7.585-2.87-.101-.296-.148-.434-.149-.316-.001-.117-.048.02-.148.316-.549 1.61-2.69 7.894-7.585 2.87-2.578-2.645-1.384-5.29 3.308-6.089-2.684.457-5.702-.298-6.53-3.257-.238-.851-.644-6.095-.644-6.803 0-3.548 3.11-2.433 5.03-.992z" />
                  </svg>
                </a>
