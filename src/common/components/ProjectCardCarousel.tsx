      ...
      <div className="rounded-t-md bg-gray-300">
        ...
        <div id="default-carousel" className="relative" data-carousel="static">
          ...
          <div className="relative overflow-hidden rounded-lg h-48">
            {props.imageList.map((imageSrc: any, index: any) => (
              <div className="hidden duration-700 ease-in-out" data-carousel-item="">
                ...
                <img src={props.imageList[index]} className="absolute block w-full h-full object-contain -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
              </div>
            ))}
          </div>
          { /* Slider indicators */}
          <div className="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
            {props.imageList.map((imageSrc: any, index: any) => (
              <button type="button" className="w-3 h-3 rounded-full" aria-current="false" aria-label={`Slide ${index}`} data-carousel-slide-to={`${index}`} />
            ))}
          </div>
          { /* Slider controls */}
