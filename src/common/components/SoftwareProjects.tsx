      ...
      <div className="bg-gray-100 rounded-lg">
        <div className="rounded-t-md bg-black">
          <a href="https://github.com/fwd/nautilus">
            <img
              src="https://raw.githubusercontent.com/fwd/nautilus/master/assets/logo-square.png"
              className="rounded-md mx-auto max-h-44"
            />
          </a>
        </div>
        <div className="p-4 space-y-2">
          <a href="https://github.com/fwd/nautilus" className="hover:underline decoration-black">
