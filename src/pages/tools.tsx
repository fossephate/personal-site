        ...
        <div className="w-full max-w-5xl mx-auto p-8 flex flex-col h-screen">
          ...
          <div className="my-12 py-2 flex flex-col items-center w-full justify-center dark:bg-gray-900 bg-gray-100 rounded-lg">
            ...
            <div className="text-center py-8">
              <h1 className="text-3xl sm:text-4xl font-bold dark:text-gray-100 pb-4">Dev Tools</h1>
          ...
          <div className="pt-2">
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <li className="p-4 px-6 bg-gray-200 shadow-xl rounded-md text-center">
                ...
                <a href="https://alephjs.org" target="_blank" className="hover:border-b hover:border-black">
                  <h2 className="text-gray-900 font-bold inline-block text-2xl">Aleph.js</h2>
                </a>
                <p className="text-gray-900 text-sm py-2">The bleeding edge, Full-Stack web framework for Deno</p>
              </li>
